export const TRANSLATIONS = {
  en: {
    "meta.title": "Dalton Craven - Full-Stack Software Engineer",
    "meta.description":
      "Full-stack software engineer in Paris specializing in React, TypeScript and web accessibility. I develop to transcend barriers and empower audiences.",
    "hero.title": "Full-Stack Software Engineer",
    "hero.tagline":
      "Crafting human-centered software solutions to develop a web that's inclusive, accessible, and open to all.",
    ...
    "section.about.paragraph1":
      "I believe that coding is about creating meaningful experiences that empower people — regardless of how they communicate or where they come from. I've developed with a wide-ranging toolkit (TypeScript, React, Python, and more) but my core focus remains the same: building products that don't exclude users due to language or ability.",
    "section.about.paragraph2":
      "That's why I'm drawn to localization and accessibility — two areas where small changes can have an enormous impact. Influenced by my background in English, French, and American Sign Language, I'm convinced that a truly equitable internet must speak the user's language in every sense. By pushing for accessible standards and “de-Englishing” the web, I hope to help shape a future where technology actually reflects the diversity of its users.",
    "section.about.location.title": "Location",
    ...
    "section.about.links.github": "GitHub",
    ...
    "section.skills.code.item1": "tRPC",
    "section.skills.code.item2": "GraphQL",
    "section.skills.code.item3": "Django",
    "section.skills.code.item4": "SQL",
    "section.skills.code.item5": "Starlette",

    "section.skills.tooling.title": "Tooling",
    "section.skills.tooling.item1": "Git & GitHub",
    "section.skills.tooling.item2": "CircleCI",
  ...
  fr: {
    ...
    "section.about.paragraph2":
      "C'est pourquoi je suis attiré par la localisation et l'accessibilité — deux domaines où de petits changements peuvent avoir un impact considérable. Influencé par mon expérience en anglais, en français et en langue des signes américaine, je suis convaincu qu'un internet véritablement équitable doit parler la langue de l'utilisateur à tous les niveaux. En promouvant des normes accessibles et en « dé-anglicisant » le web, j'espère contribuer à façonner un futur où la technologie reflète réellement la diversité de ses utilisateurs.",
    ...
    "section.skills.tooling.title": "Outils",
    "section.skills.tooling.item1": "Git & GitHub",
    "section.skills.tooling.item2": "CircleCI",
    "section.skills.tooling.item3": "AWS",
    "section.skills.tooling.item4": "Docker",
    ...
    "section.contact.description":
      "N'hésitez pas à me contacter si vous souhaitez discuter d'un projet, évoquer des opportunités ou simplement dire bonjour !",
