...
const fr = {
  ...
  intro: 'C’est difficile de se présenter virtuellement, mais voilà ce que je peux vous dire de moi',
  education_header: 'Éducation',
  education: 'Je suis étudiant en deuxième année à l’Université de Caroline du Sud. Je suis en licence d’informatique avec une mineure en psychologie. Je suis également récipiendaire de la bourse McNair, un des programmes de bourses les plus prestigieux des États-Unis, les « University Top Scholars ».',
  sa_header: 'Mon échange à l’étranger',
  study_abroad: 'J’étudie actuellement à l’Université Américaine de Paris ! Je serai en France pendant toute l’année 2021. Vivre loin de chez moi et expérimenter une culture différente de la mienne a toujours été un de mes objectifs. J’ai hâte de pouvoir en profiter pleinement une fois que la crise sanitaire sera enfin terminée.',
  ...
  work_2: 'J’y ai utilisé de nombreuses technologies (principalement Next / React et GraphQL) au sein d’une équipe de développement agile et produit régulièrement des lignes de code pour notre application. J’étais également assistant d’enseignement de premier cycle au printemps 2020, enseignant huit cours sur Linux / UNIX pour environ 250 étudiants.',
  freelance_header: 'Mon travail en freelance',
  freelance: 'Je fais aussi du développement web en freelance ! Je travaille principalement avec des petites entreprises (bien que je sois ouvert à tout), en mettant à disposition des ressources informatiques et en organisant des formation pour assurer un bon fonctionnement à long terme.',
